...
OpenCode Status Bar is adapted from `claude-status-bar` by Mick Cesanek. Its multi-session support and many refinements grew out of several community contributions. Thank you to:
...
- **[@CXRommel](https://github.com/CXRommel)**, [PR #14](https://github.com/m1ckc3s/claude-status-bar/pull/14): multi-account support.
...
- **[@florianheysen](https://github.com/florianheysen)**, [PR #15](https://github.com/m1ckc3s/claude-status-bar/pull/15): suggested and provided the base for making Crab Walking follow the System color.
